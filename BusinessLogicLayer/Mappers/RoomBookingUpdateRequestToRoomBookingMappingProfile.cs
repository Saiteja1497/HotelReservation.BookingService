...
{
    public class RoomBookingUpdateRequestToRoomBookingMappingProfile:Profile
    {
        public RoomBookingUpdateRequestToRoomBookingMappingProfile()
        {
            CreateMap<RoomBookingUpdateRequest, RoomBooking>()
